...
namespace Soccer.Pris.ViewModels
{
    public class PositionsInTournamentPageViewModel : ViewModelBase
    {
        ...
        public PositionsInTournamentPageViewModel(INavigationService navigationService,
        ...
        DelegateCommand SearchCommand => _searchCommand ?? (_searchCommand = new DelegateCommand(ShowPositions));
