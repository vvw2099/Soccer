...
namespace Soccer.Pris.ViewModels
{
    public class ClosedPredictionsForTournamentPageViewModel : ViewModelBase
    {
        ...
        public ClosedPredictionsForTournamentPageViewModel(INavigationService navigationService,
        ...
        private async void LoadPredictionsAsync()
        {
            ...
            Predictions = new ObservableCollection<PredictionItemViewModel>(list.Select(p => new PredictionItemViewModel(_apiService)
            {
